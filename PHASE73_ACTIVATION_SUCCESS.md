...
1. **task-9432f779** (P1): PyPI Publish v1.0.9
   - Command: `cd /path/to/your/project/nucleus-mcp && pipx run twine upload dist/*`
...
**Cause:** Wrong path in config: `/path/to/your/project/mcp-server-nucleus`  
**Fix:** Update config to: `/path/to/your/project/.brain` ✅
...
3. Check error log: `tail -20 /path/to/your/project/.brain/telemetry/errors.jsonl`
